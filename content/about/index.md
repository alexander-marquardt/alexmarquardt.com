...
## From Semiconductors to Full-Stack to Distributed Systems
...
I later built a full-stack web application, owning product, frontend, backend, and operations. At its peak, it scaled to tens of thousands of unique visitors per day.

Together, these experiences built a foundation in algorithmic optimization, performance-critical design, and resource trade-offs under tight constraints. The same mental models now guide how I approach distributed search, performance diagnosis, and retrieval-augmented (RAG) architectures, where architectural decisions can have outsized consequences.

## Scope and Perspective


I operate across engineering, product management, consulting, and architecture. My perspective is shaped by academic and applied computer engineering research, and enterprise-scale system design under real-world conditions.
